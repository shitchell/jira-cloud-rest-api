...
|------------ | ------------- | ------------- | -------------|
| **id** | **String** | Identifier of the routing rule. | [optional] [default to null] |
| **name** | **String** | Name of the routing rule. | [optional] [default to null] |
| **isDefault** | **Boolean** | Indicates whether given routing rule is default or not. | [optional] [default to null] |
