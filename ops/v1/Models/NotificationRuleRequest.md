...
|------------ | ------------- | ------------- | -------------|
| **name** | **String** | Name of the notification rule. | [default to null] |
| **actionType** | **String** | Type of the action that notification rule will have. | [default to null] |
| **criteria** | [**NotificationRuleRequest_criteria**](NotificationRuleRequest_criteria.md) |  | [optional] [default to null] |
| **notificationTime** | **List** | List of Time Periods that notification for schedule start/end will be sent. | [optional] [default to null] |
...
| **steps** | [**List**](NotificationRulesCreateNotificationRuleStepRequest.md) | List of steps that will be added to notification rule. | [optional] [default to null] |
| **repeat** | [**NotificationRuleRepeat**](NotificationRuleRepeat.md) |  | [optional] [default to null] |
| **enabled** | **Boolean** | If notification rule will be enabled or not when it is created. | [default to null] |
