...
| **rules** | [**List**](MaintenanceRule.md) | Rules of maintenance, which takes a list of rule objects and defines the maintenance rules over policies, integrations and syncs. | [default to null] |
