...
|------------ | ------------- | ------------- | -------------|
| **ari** | **String** | Compass component&#39;s ID. Can&#39;t be updated. Not required for creating a Project Component. | [optional] [default to null] |
...
| **isAssigneeTypeValid** | **Boolean** | Whether a user is associated with &#x60;assigneeType&#x60;. For example, if the &#x60;assigneeType&#x60; is set to &#x60;COMPONENT_LEAD&#x60; but the component lead is not set, then &#x60;false&#x60; is returned. | [optional] [default to null] |
...
| **metadata** | **Map** | Compass component&#39;s metadata. Can&#39;t be updated. Not required for creating a Project Component. | [optional] [default to null] |
...
| **projectId** | **Long** | The ID of the project the component is assigned to. | [optional] [default to null] |
...
| **self** | **URI** | The URL of the component. | [optional] [default to null] |
