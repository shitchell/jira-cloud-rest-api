...
|------------ | ------------- | ------------- | -------------|
| **maxResults** | **Integer** | The maximum number of items on the page. If the list of values is shorter than this number, then there are no more pages. | [default to null] |
...
| **values** | [**List**](FailedWebhook.md) | The list of webhooks. | [default to null] |
