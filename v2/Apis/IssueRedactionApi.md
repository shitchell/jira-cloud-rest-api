...
|------------- | ------------- | -------------|
| [**getRedactionStatus**](IssueRedactionApi.md#getRedactionStatus) | **GET** /rest/api/2/redact/status/{jobId} | Get redaction status |
| [**redact**](IssueRedactionApi.md#redact) | **POST** /rest/api/2/redact | Redact |
