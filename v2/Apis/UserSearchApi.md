...
# **findAssignableUsers**
> List findAssignableUsers(query, sessionId, username, accountId, project, issueKey, issueId, startAt, maxResults, actionDescriptorId, recommend)
...
| **project** | **String**| The project ID or project key (case sensitive). Required, unless &#x60;issueKey&#x60; or &#x60;issueId&#x60; is specified. | [optional] [default to null] |
| **issueKey** | **String**| The key of the issue. Required, unless &#x60;issueId&#x60; or &#x60;project&#x60; is specified. | [optional] [default to null] |
| **issueId** | **String**| The ID of the issue. Required, unless &#x60;issueKey&#x60; or &#x60;project&#x60; is specified. | [optional] [default to null] |
...
| **actionDescriptorId** | **Integer**| The ID of the transition. | [optional] [default to null] |
...
> List findBulkAssignableUsers(projectKeys, query, username, accountId, startAt, maxResults)
...
<a name="findUsers"></a>
# **findUsers**
> List findUsers(query, username, accountId, startAt, maxResults, property)
...
| **exclude** | [**List**](../Models/String.md)| This parameter is no longer available. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details. | [optional] [default to null] |
| **excludeAccountIds** | [**List**](../Models/String.md)| A list of account IDs to exclude from the search results. This parameter accepts a comma-separated list. Multiple account IDs can also be provided using an ampersand-separated list. For example, &#x60;excludeAccountIds&#x3D;5b10a2844c20165700ede21g,5b10a0effa615349cb016cd8&amp;excludeAccountIds&#x3D;5b10ac8d82e05b22cc7d4ef5&#x60;. Cannot be provided with &#x60;exclude&#x60;. | [optional] [default to null] |
...
> List findUsersWithAllPermissions(permissions, query, username, accountId, issueKey, projectKey, startAt, maxResults)
...
> List findUsersWithBrowsePermission(query, username, accountId, issueKey, projectKey, startAt, maxResults)
