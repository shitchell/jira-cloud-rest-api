...
|------------ | ------------- | ------------- | -------------|
| **conditionGroups** | [**List**](PreviewConditionGroupConfiguration.md) | The nested conditions of the condition group. | [optional] [default to null] |
| **conditions** | [**List**](PreviewRuleConfiguration.md) | The rules for this condition. | [optional] [default to null] |
