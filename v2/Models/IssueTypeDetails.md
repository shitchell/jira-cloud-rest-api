...
|------------ | ------------- | ------------- | -------------|
| **avatarId** | **Long** | The ID of the issue type&#39;s avatar. | [optional] [default to null] |
| **description** | **String** | The description of the issue type. | [optional] [default to null] |
| **entityId** | **UUID** | Unique ID for next-gen projects. | [optional] [default to null] |
| **hierarchyLevel** | **Integer** | Hierarchy level of the issue type. | [optional] [default to null] |
...
| **subtask** | **Boolean** | Whether this issue type is used to create subtasks. | [optional] [default to null] |
