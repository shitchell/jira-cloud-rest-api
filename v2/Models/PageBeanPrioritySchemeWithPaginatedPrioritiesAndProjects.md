...
| **nextPage** | **URI** | If there is another page of results, the URL of the next page. | [optional] [default to null] |
| **self** | **URI** | The URL of the page. | [optional] [default to null] |
...
| **values** | [**List**](PrioritySchemeWithPaginatedPrioritiesAndProjects.md) | The list of items. | [optional] [default to null] |
